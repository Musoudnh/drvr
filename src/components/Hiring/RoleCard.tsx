    ...
    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
      <div className="p-4">
        ...
        <div className="bg-[#f8f9fb] rounded-lg p-3 mb-3">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-medium text-gray-600">Base Compensation</span>
          ...
          <div className="pt-2 mt-2 border-t border-gray-300 flex items-center justify-between">
            <span className="text-xs font-semibold text-[#101010]">Total Loaded Cost</span>
        ...
        {role.worker_classification === 'w2' && (
          <button
            ...
            className="w-full flex items-center justify-center gap-2 text-xs font-medium text-[#101010] hover:text-gray-700 transition-colors"
          >
            {expanded ? (
              <>
      ...
      {expanded && role.worker_classification === 'w2' && (
        <div className="border-t border-gray-200 bg-gray-50 p-4">
          <h4 className="text-xs font-semibold text-[#101010] mb-3">Tax & Benefit Breakdown</h4>
