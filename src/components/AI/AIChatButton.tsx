...
const AIChatButton: React.FC<AIChatButtonProps> = ({ onClick }) => {
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <div className="absolute right-full mr-3 bg-[#101010] text-white px-3 py-2 rounded-lg text-sm whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200">
        AI Financial Analyst
        <div className="absolute top-1/2 -right-1 transform -translate-y-1/2 w-2 h-2 bg-[#101010] rotate-45" />
      </div>
    </button>
  );
};
