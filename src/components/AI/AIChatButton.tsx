...
const AIChatButton: React.FC<AIChatButtonProps> = ({ onClick }) => {
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <div className="absolute right-full mr-3 bg-[#101010] text-white px-3 py-2 rounded-lg text-xs whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200">
