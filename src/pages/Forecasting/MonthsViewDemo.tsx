        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-4">
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="text-xs text-blue-600 font-medium mb-1">Total Revenue</div>
              <div className="text-2xl font-bold text-blue-900">
                ${totals.revenueTotal.toLocaleString()}
              </div>
            </div>
            <div className="bg-white border border-red-200 rounded-lg p-4">
              <div className="text-xs text-red-600 font-medium mb-1">Total Expenses</div>
          ...
          <div className="space-y-8">
            <div>
              <div className="mb-4 pb-2 border-b border-gray-200">
                <h3 className="text-xs font-semibold text-gray-800">Revenue</h3>
              </div>
              <MonthsView
              ...
              {selectedRevenueMonths.length > 0 && (
                <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button className="px-3 py-1.5 bg-white border border-blue-300 text-blue-700 text-xs rounded hover:bg-blue-50 transition-colors">
                      Set Fixed Amount
                    </button>
                    <button className="px-3 py-1.5 bg-white border border-blue-300 text-blue-700 text-xs rounded hover:bg-blue-50 transition-colors">
                      Adjust by %
            ...
            <div>
              <div className="mb-4 pb-2 border-b border-gray-200">
                <h3 className="text-xs font-semibold text-gray-800">Operating Expenses</h3>
              </div>
              <MonthsView
              ...
              {selectedExpenseMonths.length > 0 && (
                <div className="mt-4 p-4 bg-orange-50 border border-orange-200 rounded-lg">
                  ...
                  <div className="flex gap-2">
                    <button className="px-3 py-1.5 bg-orange-600 text-white text-xs rounded hover:bg-orange-700 transition-colors">
                      Apply Growth Rate
                    </button>
                    <button className="px-3 py-1.5 bg-white border border-orange-300 text-orange-700 text-xs rounded hover:bg-orange-50 transition-colors">
                      Set Fixed Amount
                    </button>
                    <button className="px-3 py-1.5 bg-white border border-orange-300 text-orange-700 text-xs rounded hover:bg-orange-50 transition-colors">
                      Adjust by %
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 bg-purple-100 rounded-full flex items-center justify-center flex-shrink-0">
                  <span className="text-xs font-semibold text-purple-700">5</span>
                </div>
                <div>
              ...
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 bg-red-100 rounded-full flex items-center justify-center flex-shrink-0">
                  <span className="text-xs font-semibold text-red-700">6</span>
                </div>
                <div>
