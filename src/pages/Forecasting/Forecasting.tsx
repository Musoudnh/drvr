              ...
              <table className="w-full text-sm">
                <thead className="sticky top-0 bg-white z-10">
                  <tr className="border-b-2 border-gray-300">
                    <th className="text-left py-3 px-4 font-bold text-gray-800 w-48 sticky left-48 bg-white">Description</th>
                        ...
                        {expandedCategories.includes(category) && categoryGLCodes.map(glCode => (
                          <React.Fragment key={glCode.code}>
                            <tr className="border-b border-gray-100 hover:bg-gray-50 group">
                              <td className="py-3 px-4 text-sm sticky left-48 bg-white group-hover:bg-gray-50">
